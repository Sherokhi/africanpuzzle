...
$menu=array(
    "follow","","",@FOLLOW,$right,
	'<i class="fa fa-print" aria-hidden="true"></i> Imprimer',"/print","","",@VIEW_ALL
    );
...
<div class="m10">
    <div class="widget-header"><i class="fa fa-heartbeat" aria-hidden="true"></i>
        <h5><?php echo $this->h('Mes suivis'); ?></h5>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="print-hidden">
                    	<a data-toggle="modal" href="<?php echo $this->html()->url('follow/'.$follow->id().'/edit'); ?>" data-target="#modFollow" class="btn mod"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                    	<a href="<?php echo $this->html()->url('follow/'.$follow->id().'/delete'); ?>" class="btn mod" onclick="return confirm('Voulez ous vraiment supprimer ce suivi ?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    </td>
                </tr>
                <?php endforeach ?>
            </tbody>
...
function FilterTable(){
    ...
    var tf = setFilterGrid('follow-table', filtersConfig);
