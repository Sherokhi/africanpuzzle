...
foreach($follows as $follow){
	...
	if ($follow->mod_colleague_id()){
		...
		$pdf->SetX($marginLeft + 10);
		$pdf->MultiCell(0,$lineHeight,'Modifi� le '.date_format($follow->mod_date(), 'j F Y').' par '.$follow->mod_colleague_first_name().' '.$follow->mod_colleague_name(),0,'J');
...
die("ERREUR DANS LES LOGS SI PAS PRESENT");
