    ...
    <tr data-row-id="<?= $pupil['idChild'] ?>">
        <td class="text-left">
            ...
            <div class="d-flex flex-wrap">
                ...
                ?>
                <div class="mr-4 has-badge"><sup class="badge bg-warning"><?= $pupil['chiAge'] ?></sup><img class="shadow-z5 thumb_user48 rounded" src="<?php echo $this->html()->url($photo); ?>" alt="pupil"></div>
                <div>
                    <p class="my-1"><strong><?= strtoupper ($pupil['chiName']) ?></strong>&nbsp; <?= $pupil['chiFirstName'] ?></p>
                    <small><?= $pupil['chiAddress'] !== '' ? $pupil['chiAddress']."<br>" : ''  ?></small>
                    <small><em class="ion-record text-danger mr-2"></em><?= $pupil['useName'] ?> <?= $pupil['useFirstName'] ?></small>
                </div>
            </div>
        </td>
        <td class="text-left">
