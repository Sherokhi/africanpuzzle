$(function () {
 ...
 function runPermissionSweetAlert(isPermitted,forWaht) {
    ...
    switch (forWaht) {
        case 'act':
            if (isPermitted !=1){
                ...
                swal({
                    className: "bg-alert-warning-light",
                    icon: 'warning',
                    title: 'Gallerie photos',
                    text: '! Accès reservé aux utilisateurs connectés !'
                  });
        ...
        case 'rem':
                if (isPermitted !=1){
                    ...
                    swal('Gallerie photos', '! Accès reservé aux utilisateurs connectés !' , 'warning', {
                        className: "bg-alert-warning-light",
                      });
        ...
        if (isPermitted !=1){
            ...
            swal('Filleuls', '! Accès reservé aux utilisateurs connectés !' , 'warning', {
                className: "bg-alert-warning-light",
            });
        }
        break;
    ...
    $('.check_act_gallery').on('click', function(e) {
        e.preventDefault();
...
(function() {
    ...
    function runSweetAlert() {
        ...
        $('.check_gallery').on('click', function(e) {
            e.preventDefault();
            swal('Here\'s a message!');
        });
    ...
    function formAdvanced() {
        ...
        $('.ui-slider-values').each(function() {
            ...
            function updateValues() {
                ...
                $('#ui-slider-value-lower').html(Number.parseFloat(values[0]).toFixed(0));
                $('#ui-slider-value-upper').html(Number.parseFloat(values[1]).toFixed(0));
            }
        });

        $('.ui-slider-values_2').each(function() {
            var slider = this;
            ...
            function updateValues() {
                var values = slider.noUiSlider.get();
                // Connecto to live values
                $('#ui-slider-value-lower_2').html(Number.parseFloat(values[0]).toFixed(0));
                $('#ui-slider-value-upper_2').html(Number.parseFloat(values[1]).toFixed(0));
            }
        });

        $('.ui-slider-values_3').each(function() {
            var slider = this;
            ...
            function updateValues() {
                var values = slider.noUiSlider.get();
                // Connecto to live values
                $('#ui-slider-value-lower_3').html(Number.parseFloat(values[0]).toFixed(0));
                $('#ui-slider-value-upper_3').html(Number.parseFloat(values[1]).toFixed(0));
            }
        });
